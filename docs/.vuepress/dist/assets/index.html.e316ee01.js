import{_ as n,o as s,c as a,e as t}from"./app.2c1ad979.js";const p={},o=t(`<h1 id="amfe-flexible\u6E90\u7801\u9605\u8BFB" tabindex="-1"><a class="header-anchor" href="#amfe-flexible\u6E90\u7801\u9605\u8BFB" aria-hidden="true">#</a> amfe-flexible\u6E90\u7801\u9605\u8BFB</h1><p>\u79FB\u52A8\u7AEF\u9002\u914D\u89E3\u51B3\u65B9\u6848</p><h2 id="\u5B89\u88C5" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5" aria-hidden="true">#</a> \u5B89\u88C5</h2><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> amfe-flexible -S
<span class="token function">npm</span> <span class="token function">install</span> postcss-pxtorem -D
</code></pre></div><h2 id="\u4F7F\u7528" tabindex="-1"><a class="header-anchor" href="#\u4F7F\u7528" aria-hidden="true">#</a> \u4F7F\u7528</h2><p>\u5728 index.html \u7684 head\u6807\u7B7E \u4E2D\u6DFB\u52A0\u5982\u4E0B\u4EE3\u7801\uFF1A</p><div class="language-html ext-html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">name</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>viewport<span class="token punctuation">&quot;</span></span> 
...
</code></pre></div><p>\u5728 main.js\u4E2D \u5F15\u7528</p><div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token string">&#39;amfe-flexible&#39;</span>
</code></pre></div><p>\u5728 postcss.config \u4E2D\u914D\u7F6E</p><div class="language-javascript ext-js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">plugins</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">autoprefixer</span><span class="token operator">:</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token comment">// \u81EA\u52A8\u6DFB\u52A0\u524D\u7F00\uFF0Cvue\u811A\u624B\u67B6\u81EA\u5E26</span>
    <span class="token string-property property">&quot;postcss-pxtorem&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
      <span class="token literal-property property">rootValue</span><span class="token operator">:</span> <span class="token number">37.5</span><span class="token punctuation">,</span> <span class="token comment">//\u7ED3\u679C\u4E3A\uFF1A\u8BBE\u8BA1\u7A3F\u5143\u7D20\u5C3A\u5BF8/16\uFF0C\u6BD4\u5982\u5143\u7D20\u5BBD320px,\u6700\u7EC8\u9875\u9762\u4F1A\u6362\u7B97\u6210 20rem</span>
      <span class="token literal-property property">propList</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&quot;*&quot;</span><span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token comment">//\u662F\u4E00\u4E2A\u5B58\u50A8\u54EA\u4E9B\u5C06\u88AB\u8F6C\u6362\u7684\u5C5E\u6027\u5217\u8868\uFF0C\u8FD9\u91CC\u8BBE\u7F6E\u4E3A[&#39;*&#39;]\u5168\u90E8\uFF0C\u5047\u8BBE\u9700\u8981\u4EC5\u5BF9\u8FB9\u6846\u8FDB\u884C\u8BBE\u7F6E\uFF0C\u53EF\u4EE5\u5199[&#39;*&#39;, &#39;!border*&#39;]</span>
      <span class="token literal-property property">unitPrecision</span><span class="token operator">:</span> <span class="token number">5</span><span class="token punctuation">,</span> <span class="token comment">//\u4FDD\u7559rem\u5C0F\u6570\u70B9\u591A\u5C11\u4F4D</span>
      <span class="token literal-property property">mediaQuery</span><span class="token operator">:</span> <span class="token boolean">false</span><span class="token punctuation">,</span> <span class="token comment">//\u5A92\u4F53\u67E5\u8BE2( @media screen \u4E4B\u7C7B\u7684)\u4E2D\u4E0D\u751F\u6548</span>
      <span class="token literal-property property">minPixelValue</span><span class="token operator">:</span> <span class="token number">12</span><span class="token punctuation">,</span> <span class="token comment">//px\u5C0F\u4E8E12\u7684\u4E0D\u4F1A\u88AB\u8F6C\u6362</span>
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>

<span class="token comment">// \u6216\u8005 package.json \u4E2D\u914D\u7F6E</span>
  <span class="token string-property property">&quot;postcss&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token string-property property">&quot;plugins&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
      ...
      <span class="token string-property property">&quot;postcss-pxtorem&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        <span class="token string-property property">&quot;rootValue&quot;</span><span class="token operator">:</span> <span class="token number">37.5</span><span class="token punctuation">,</span>
        <span class="token string-property property">&quot;propList&quot;</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&quot;*&quot;</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
        <span class="token string-property property">&quot;unitPrecision&quot;</span><span class="token operator">:</span> <span class="token number">5</span><span class="token punctuation">,</span>
        <span class="token string-property property">&quot;mediaQuery&quot;</span><span class="token operator">:</span> <span class="token boolean">false</span><span class="token punctuation">,</span>
        <span class="token string-property property">&quot;minPixelValue&quot;</span><span class="token operator">:</span> <span class="token number">12</span>
      <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre></div><ul><li>autoprefixer\uFF1Acss\u6D4F\u89C8\u5668\u517C\u5BB9\uFF0C\u5373\u6DFB\u52A0\u524D\u7F00</li><li>postcss-pxtorem\uFF1A\u5C06px\u8F6C\u5316\u4E3Arem\u6765\u9002\u914D\uFF0C\u5199\u5728\u5185\u8054\u6837\u5F0F\u4E2D\u7684\u65E0\u6CD5\u8F6C\u5316\uFF0C<code>6.0</code>\u7248\u672C\u7684\u4F1A\u63D0\u793A\u65E0\u6CD5\u4F7F\u7528\uFF0C\u5EFA\u8BAE\u964D\u7EA7\u5230<code>5.1.1</code>\u7248\u672C</li></ul><h2 id="\u8BF4\u660E" tabindex="-1"><a class="header-anchor" href="#\u8BF4\u660E" aria-hidden="true">#</a> \u8BF4\u660E</h2><h3 id="\u4EC0\u4E48\u662Frem" tabindex="-1"><a class="header-anchor" href="#\u4EC0\u4E48\u662Frem" aria-hidden="true">#</a> \u4EC0\u4E48\u662Frem</h3><p>rem\uFF08font size of the root element\uFF09\u662F\u6307\u76F8\u5BF9\u4E8E\u6839\u5143\u7D20\u7684\u5B57\u4F53\u5927\u5C0F\u7684\u5355\u4F4D</p><h2 id="amfe-flexible\u6E90\u7801" tabindex="-1"><a class="header-anchor" href="#amfe-flexible\u6E90\u7801" aria-hidden="true">#</a> amfe-flexible\u6E90\u7801</h2><div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token comment">// \u7ACB\u5373\u6267\u884C\u51FD\u6570 ( function(){}() ) \u6216\u8005 ( function(){} )(),\u4F20\u5165window\uFF0Cdocument\u4E3B\u8981\u662F\u4E3A\u4E86\u538B\u7F29\u4F18\u5316</span>
<span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token function">flexible</span> <span class="token punctuation">(</span><span class="token parameter">window<span class="token punctuation">,</span> document</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// \u83B7\u53D6\u6587\u6863\u5BF9\u8C61\u7684\u6839\u5143\u7D20: html</span>
    ...
    <span class="token comment">// \u83B7\u53D6dpr</span>
    ...
    <span class="token comment">// TODO 1. \u8BBE\u7F6E body \u7684 fontSize = 12 * dpr (px)</span>
    <span class="token comment">// body\u4E0A\u8BBE\u7F6E12 * dpr\u7684font-size\u503C\uFF0C\u4E3A\u4E86\u91CD\u7F6E\u9875\u9762\u4E2D\u7684\u5B57\u4F53\u9ED8\u8BA4\u503C\uFF0C\u4E0D\u7136\u6CA1\u6709\u8BBE\u7F6Efont-size\u7684\u5143\u7D20\u4F1A\u7EE7\u627Fhtml\u4E0A\u7684font-size\uFF0C\u53D8\u5F97\u5F88\u5927\u3002</span>
    ...
    <span class="token punctuation">}</span>
    <span class="token comment">// TODO 2.\u8BBE\u7F6E \u6839\u5143\u7D20: html \u7684 fontSize = clientWidth / 10 (px)</span>
    ...
    <span class="token comment">// TODO 3. \u7A97\u53E3\u5927\u5C0F\u53D8\u5316\u7684\u65F6\u5019\uFF0C\u91CD\u65B0\u8BBE\u7F6E html\u7684fontSize</span>
    ...
    <span class="token comment">// TODO 4. \u6BCF\u6B21\u52A0\u8F7D\u9875\u9762\u65F6\u89E6\u53D1</span>
    window<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">&#39;pageshow&#39;</span><span class="token punctuation">,</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">e</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token comment">//  \u5982\u679C\u9875\u9762\u4ECE\u6D4F\u89C8\u5668\u7684\u7F13\u5B58\u4E2D\u8BFB\u53D6</span>
...
</code></pre></div>`,17),e=[o];function c(l,u){return s(),a("div",null,e)}var r=n(p,[["render",c],["__file","index.html.vue"]]);export{r as default};
