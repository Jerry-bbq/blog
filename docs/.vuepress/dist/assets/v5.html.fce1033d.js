import{_ as u,r as t,o as i,c as k,a as n,b as a,w as p,d as e,e as s}from"./app.41542100.js";const d={},g=e(`<h1 id="webpack5" tabindex="-1"><a class="header-anchor" href="#webpack5" aria-hidden="true">#</a> Webpack5</h1><p>webpack \u662F\u4E00\u4E2A\u9759\u6001\u8D44\u6E90\u6253\u5305\u5DE5\u5177</p><p>\u5B83\u4F1A\u4EE5\u4E00\u4E2A\u6216\u591A\u4E2A\u6587\u4EF6\u6253\u5305\u4F5C\u4E3A\u6253\u5305\u7684\u5165\u53E3\uFF0C\u5C06\u6574\u4E2A\u9879\u76EE\u6240\u6709\u6587\u4EF6\u7F16\u8BD1\u7EC4\u5408\u6210\u4E00\u4E2A\u6216\u591A\u4E2A\u6587\u4EF6\u8F93\u51FA\u51FA\u53BB\uFF0C\u8F93\u51FA\u7684\u6587\u4EF6\u5C31\u662F\u7F16\u8BD1\u597D\u7684\u6587\u4EF6\uFF0C\u5C31\u53EF\u4EE5\u5728\u6D4F\u89C8\u5668\u7AEF\u8FD0\u884C\u3002</p><p>webpack \u672C\u8EAB\u529F\u80FD\u6BD4\u8F83\u5C11\uFF0C\u53EA\u80FD\u5904\u7406 js \u8D44\u6E90\uFF0C\u6240\u4EE5\u9700\u8981\u4F9D\u8D56\u5176\u4ED6\u7684 loader\uFF08\u6BD4\u5982 css...\uFF09</p><p>\u4E94\u4E2A\u6838\u5FC3\u6982\u5FF5\uFF1A</p><ul><li>entry\uFF1A\u5165\u53E3\u6587\u4EF6</li><li>output\uFF1A\u8F93\u51FA</li><li>loader\uFF1A\u52A0\u8F7D\u5668</li><li>plugins\uFF1A\u63D2\u4EF6\uFF0C\u6269\u5C55 webpack \u7684\u529F\u80FD</li><li>mode\uFF1A<code>development</code> \u548C <code>production</code></li></ul><h2 id="\u81EA\u5B9A\u4E49-webpack-\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#\u81EA\u5B9A\u4E49-webpack-\u914D\u7F6E" aria-hidden="true">#</a> \u81EA\u5B9A\u4E49 webpack \u914D\u7F6E</h2><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u5B89\u88C5\u4F9D\u8D56</span>
...
npx webpack
</code></pre></div><h2 id="\u57FA\u7840\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#\u57FA\u7840\u914D\u7F6E" aria-hidden="true">#</a> \u57FA\u7840\u914D\u7F6E</h2><div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token comment">// webpack.config.js</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u5904\u7406css\u6837\u5F0F\u8D44\u6E90" tabindex="-1"><a class="header-anchor" href="#\u5904\u7406css\u6837\u5F0F\u8D44\u6E90" aria-hidden="true">#</a> \u5904\u7406css\u6837\u5F0F\u8D44\u6E90</h2><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> style-loader css-loader -D 
</code></pre></div><ul><li>style-loader\uFF1A\u5C06js\u4E2Dcss\u901A\u8FC7\u521B\u5EFAstyle\u6807\u7B7E\u6DFB\u52A0\u5230html\u6587\u4EF6\u4E2D\u751F\u6548</li><li>css-loader\uFF1A\u5C06css\u8D44\u6E90\u7F16\u8BD1\u6210commonjs\u7684\u6A21\u5757\u5230js\u4E2D</li></ul><div class="language-javascript ext-js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre></div><h3 id="\u5904\u7406less" tabindex="-1"><a class="header-anchor" href="#\u5904\u7406less" aria-hidden="true">#</a> \u5904\u7406less</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> less-loader <span class="token function">less</span> -D
...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u5904\u7406\u5B57\u4F53\u56FE\u6807\u8D44\u6E90" tabindex="-1"><a class="header-anchor" href="#\u5904\u7406\u5B57\u4F53\u56FE\u6807\u8D44\u6E90" aria-hidden="true">#</a> \u5904\u7406\u5B57\u4F53\u56FE\u6807\u8D44\u6E90</h2><ul><li>asset/resource\uFF1A\u4E0D\u4F1A\u8F6C\u5316\u4E3Abase64</li></ul><div class="language-javascript ext-js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        <span class="token literal-property property">rules</span><span class="token operator">:</span> <span class="token punctuation">[</span>
            <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u5904\u7406js\u8D44\u6E90" tabindex="-1"><a class="header-anchor" href="#\u5904\u7406js\u8D44\u6E90" aria-hidden="true">#</a> \u5904\u7406js\u8D44\u6E90</h2><p>webpack\u5BF9\u4E8Ejs\u7684\u5904\u7406\u662F\u6709\u9650\u7684\uFF0C\u53EA\u80FD\u7F16\u8BD1js\u4E2D\u7684es\u6A21\u5757\u5316\u8BED\u6CD5\uFF0C\u4E0D\u80FD\u7F16\u8BD1\u5176\u4ED6\u8BED\u6CD5\uFF0C\u5BFC\u81F4js\u4E0D\u80FD\u5728IE\u7B49\u6D4F\u89C8\u5668\u8FD0\u884C\uFF0C\u6240\u4EE5\u8981\u505A\u4E00\u4E9B\u517C\u5BB9\u6027\u5904\u7406</p><ul><li>\u9488\u5BF9\u517C\u5BB9\u6027\uFF0C\u4F7F\u7528babel\u5904\u7406</li><li>\u9488\u5BF9\u4EE3\u7801\u683C\u5F0F\u5316\uFF0C\u4F7F\u7528eslint\u5904\u7406</li></ul><h3 id="eslint" tabindex="-1"><a class="header-anchor" href="#eslint" aria-hidden="true">#</a> eslint</h3>`,40),y=n("li",null,"\u53EF\u7EC4\u88C5\u7684JavaScript\u548CJSX\u68C0\u67E5\u5DE5\u5177",-1),m=n("li",null,"\u4F7F\u7528eslint\uFF0C\u5173\u952E\u662Feslint\u914D\u7F6E\u6587\u4EF6\uFF0C\u91CC\u9762\u5199\u5404\u79CDrules\u89C4\u5219",-1),x={href:"https://cn.eslint.org/docs/user-guide/configuring",target:"_blank",rel:"noopener noreferrer"},h=s("esling"),b=e(`<p>\u914D\u7F6E\u6587\u4EF6\u7684\u5199\u6CD5\uFF1A</p><ul><li>.eslintrc</li><li>.eslintrc.js</li><li>.eslintrc.json</li><li>\u8FD8\u5728\u53EF\u4EE5\u5728<code>package.json</code>\u4E2D<code>eslintconfig</code>\u914D\u7F6E</li></ul><p>\u914D\u7F6E\u6587\u4EF6\uFF1A</p><div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token comment">// .eslintrc.js</span>
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
