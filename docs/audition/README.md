...
面试官你好，我叫xx，今天来面试贵公司的前端开发工程师岗位。我是16年开始就从事前端开发，已有五年多的时间，有三年多的vue项目开发经验。有三分工作经历，分别是美的楼宇研究院，杭州接力棒，杭州银米互联网金融三家公司，在上家公司主要主要是开发云集控app项目，使用uniapp技术。平常喜欢逛一些技术社区来丰富自己的技术，也有自己的开源项目，比如常用函数工具库，以此来做一些技术沉淀。以上是我的个人介绍，谢谢
